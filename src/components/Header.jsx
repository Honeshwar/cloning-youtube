...
//     const searchQueryHandler = (event)=>{//when pass arg as "searchButton", expect event when call this func by single arrow func
//       console.log(event);
//         if((event?.key === 'Enter' || event === "searchButton") && searchQuery?.length > 0){//optional Chaining (?) //event.type == "click"
...
//           value={searchQuery}
//           onKeyUp={()=> searchQueryHandler('searchButton')}
//           placeholder='Search'
//           />
//           </div>
